...
\hypersetup{
  pdftitle={Fermionic Matter and Chirality from Projective Dirac Admissibility},
  pdfauthor={J\'er\^ome Beau},
  pdfsubject={Fermions as the spinorial face of the admissible Weil module: chiral selection,
    hypercharge rigidity and generation multiplicity from projective Dirac admissibility},
  pdfkeywords={admissible spinor bundle, metaplectic lift, non-injective projection,
    Weil representation, projected Dirac operator, chiral selection, hypercharge rigidity,
...
\begin{document}
  ...
  \begin{abstract}
    ...
    They arise as the spinorial face of the Weil module carried by the admissible fibre on a
    supplied Heisenberg carrier, once its metaplectic Lie-algebraic structure is complexified by
    the Lorentzian metric established in the geometric branch of the programme.
    That carrier is supplied rather than selected by the axioms, so every result below inherits it.
    ...
    The colour-coupled quark sector is obtained by tensoring with a colour module
    $V_{\mathrm{color}}$ that is a supplied input rather than a derived one: O31 is a withdrawal
    notice, and neither the admissibility of a colour triplet nor the identification of
    $\mathrm{SU}(3)$ is established.
    Both the quark sector and the hypercharge selection therefore carry that supplied module as a
    hypothesis; the $V{-}A$ structure and the generation factor do not.
  ...
  \section{Introduction}
    ...
    \subsection{Position of the problem}
      ...
      They arise as the spinorial face of the Weil module carried by the admissible fibre on a
      supplied Heisenberg carrier, once its metaplectic lift is interpreted through the Lorentzian
  ...
  \subsection{Status and dependencies}
    ...
    The $V{-}A$ structure of Theorem~B is therefore unconditional \emph{relative to the supplied
    Heisenberg carrier}: its remaining dependencies are that carrier, the axiomatic chain
    A1--A4~\cite{Beau2026m} and the upstream BI parity datum~\cite{Beau2026a34,Beau2026u1}.
    It does not depend on the colour module.
  ...
  \subsection{Electroweak tensor sectors}
    ...
    \begin{proof}
      On the supplied Heisenberg carrier of Subsection~\ref{ssec:weil-metaplectic}, the
      identification $F_n \simeq V_\rho$ gives the admissible fibre the canonical symplectic
      structure of the Weil representation~\cite{Beau2026m,Beau2026HeisenbergStructure}.
  ...
  \subsection{Status of the colour factor}
    ...
    \begin{remark}
      ...
      \begin{equation}
        ...
        \begin{cases}
          S_\Pi \otimes \mathbb{C}^3_{\mathrm{gen}}
          & \text{electroweak/leptonic carrier, no further condition,} \\[4pt]
      ...
      Subsection~\ref{ssec:weil-metaplectic}, which the whole construction inherits; the
  ...
  bundle.
  They arise as the spinorial face of the Weil module carried by the admissible fibre on a
  supplied Heisenberg carrier, revealed through the Lorentzian complexification of its metaplectic
  lift.
  ...
  \[
    ...
    \mathbb{C}^3_{\mathrm{gen}},
  \]
  whose first summand carries no condition beyond the supplied Heisenberg carrier, and whose
  second carries the supplied colour module as well.
