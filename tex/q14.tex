...
\begin{document}
  ...
  The present paper identifies the structural carrier of these data but does not
  derive the numerical mass spectrum.
  The next step is therefore to study the eigenstructure of $E_\Pi$ on
  $S_\Pi \otimes \mathbb{C}^3_{\mathrm{gen}}$,
  and to compare it with the charged-lepton mass hierarchy established in the
  spectral admissibility sub-programme~\cite{Beau2026a4,Beau2026a29}
  and possible quark mixing patterns.
