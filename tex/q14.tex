...
\begin{document}
  ...
  \subsection{Status and the amplitude problem}
    ...
    $J_\Pi$-odd sector (Proposition~\ref{prop:dg-odd}), and is carried by the oriented cascade
    generator through its non-zero $J_3$ projection (Proposition~\ref{prop:dg-bridge}).
  ...
  Second, the connection between $[H\text{-color}]_{\mathrm{eff}}$ (proved
  analytically in~\cite{Beau2026a35,Beau2026a36}) and the exact pointwise equality
  of BFS capacity profiles at finite~$q$ is a separately bounded numerical question,
  characterised quantitatively as an $O(q^{-1})$ modulation bias by O32.
  ...
  The qualitative mechanism is thereby fixed; the amplitude of the splitting remains open and is
  deferred to the normalisation of the admissibility cascade, the comparison with the charged-lepton
  mass hierarchy~\cite{Beau2026a4,Beau2026a29} and possible quark mixing patterns being the
  downstream target.
