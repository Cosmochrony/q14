...
\begin{document}
  ...
  \begin{abstract}
    ...
    projection.
    Under the spinorial lift of BI parity (Hypothesis~\ref{hyp:spinorial-bi-lift}),
  ...
  \subsection{Conditional status and dependencies}
    \label{ssec:status}
    ...
    The only additional technical condition used in the fermionic sector is the
    spinorial lift of BI parity.
    It is isolated as Hypothesis~\ref{hyp:spinorial-bi-lift}; all subsequent uses of
    chirality and $V{-}A$ depend on this explicitly stated condition.
  ...
  \subsection{Spinorial lift of BI parity}
    ...
    \begin{hypothesis}[Spinorial BI lift]
      \label{hyp:spinorial-bi-lift}
      The BI parity relation on conjugate Weil sectors lifts to an antilinear
      endomorphism $J_\Pi$ of $S_\Pi$ satisfying
      \begin{equation}
    ...
    \begin{proposition}[BI parity and left-admissibility]
      ...
      Assume Hypothesis~\ref{hyp:spinorial-bi-lift}, and assume that admissibility
      selects the orientation-compatible branch.
      Then $E_\Pi$ is left-admissible:
      \[
        P_R E_\Pi P_R = 0 .
      \]
    \end{proposition}
  ...
  \subsection{Trace constraints on projected hypercharge weights}
    ...
    \begin{proposition}[Spectral anomaly constraints]
      ...
      (Hypothesis~\ref{hyp:spinorial-bi-lift},
  ...
  \section{The Conditional Colour Sector}
  \label{sec:colour}
  ...
  \subsection{Status of the colour factor}
    ...
    \begin{proposition}[Colour sector extension]
      \label{prop:conditional-colour-extension}
  ...
  Several open directions remain sharply delimited.
  First, the spinorial lift of BI parity must be derived analytically: showing that
  the antilinear conjugation $\pi_{q-c}(v) = \overline{\pi_c(v)}$ lifts to an
  antilinear endomorphism $J_\Pi$ satisfying~\eqref{eq:jpi-conditions} is the
  remaining technical core of the $V{-}A$ result.
  ...
  Third, the connection between $[H\text{-color}]_{\mathrm{eff}}$ (proved
