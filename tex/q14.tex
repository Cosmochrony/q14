...
\begin{document}
  ...
  \begin{abstract}
    ...
    $V_{\mathrm{color}}$, unconditional at the effective level
    ($[H\text{-color}]_{\mathrm{eff}}$ established in~\cite{Beau2026a35,Beau2026a36}).
  \end{abstract}
  ...
  \subsection{Conditional status and dependencies}
    ...
    at the effective level: $[H\text{-color}]_{\mathrm{eff}}$ is established
    analytically in~\cite{Beau2026a35,Beau2026a36}.
  ...
  \subsection{Organisation}
    ...
    analytical status of $[H\text{-color}]_{\mathrm{eff}}$.
  ...
  \subsection{Status of the colour factor}
    ...
    The factor $V_{\mathrm{color}}$ depends on the $\SU(3)$ sector, which is now
    unconditional at the effective level.

    The identification of $\SU(3)$ as the colour gauge group follows from
    $[H\text{-color}]_{\mathrm{eff}}$ (equality of effective BFS capacity
    exponents $\delta_c = \delta_{\omega c} = \delta_{\omega^2 c}$), established
    analytically in~\cite{Beau2026a35,Beau2026a36} via two complementary
    mechanisms: the intra-coset Vandermonde symmetry (O31) and the
    modulation-frequency argument for the O12 fingerprint observable (O32).
    The triplet colour module therefore unconditionally defines
    $V_{\mathrm{color}} \in \operatorname{Rep}(\SU(3))$ in the effective limit,
    and the quark sector~\eqref{eq:quark-bundle} is an unconditional output
    of the present paper at this level.
    ...
    \begin{remark}
      ...
      \begin{equation}
        ...
        \begin{cases}
          ...
          & \text{quark carrier, unconditional at the effective level.}
        \end{cases}
      \end{equation}
    \end{remark}
  ...
  \]
  This step is unconditional at the effective level:
  $[H\text{-color}]_{\mathrm{eff}}$ is established analytically
  ...
  \[
    ...
    \mathbb{C}^3_{\mathrm{gen}},
  \]
  with both summands unconditional at the effective level.
